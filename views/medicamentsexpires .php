<?php
   ...
   # include('modal.php');
    ...
    $req = $con->prepare("SELECT produit.description as m,entree_produit.date_expiration as  d FROM entree_produit JOIN produit ON produit.id=entree_produit.id_produit WHERE entree_produit.date_expiration<=NOW();");
    $req->execute();
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="ajouter_categorie">Medicaments éxpirés</h5>
